...
commentall = pd.read_csv('../newdata/t_comment.csv')
...
for d in date_list:
    ...
    all_feature['dt'] = d
    #晒单数和评论数的比值
    #all_feature['dis_cmmt_rate']=all_feature.dis_num_sum.astype('float')/all_feature.cmmt_num_sum
    #好评数和评论数的比值
...
#输出
feature.to_csv('../newdata/static_comment.csv', index=False)