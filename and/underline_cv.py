...
#获取static_order
static_order = pd.read_csv('../newdata/static_order.csv')
...
train.to_csv('../newdata/underline_train_1126.csv', index=False)
test.to_csv('../newdata/underline_test_1126.csv', index=False)